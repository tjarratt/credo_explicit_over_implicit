defmodule CredoExplicitOverImplicit.ImportsTest do
  ...
  describe "gracefully handles edge cases" do
    test "when modules have namespaces" do
      """
      defmodule CheekyModule do
    ...
    test "when using 'import warn: false'" do
      """
      defmodule CheekyModule do
        import Good.Module, only: [my_func: 1], warn: false
      end
      """
      |> to_source_file()
      |> run_check(Imports)
